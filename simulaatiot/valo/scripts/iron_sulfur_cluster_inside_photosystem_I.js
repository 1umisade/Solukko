/* iron_sulfur_cluster_inside_photosystem_I - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/iron_sulfur_cluster_inside_photosystem_I.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['iron_sulfur_cluster_inside_photosystem_I'] = {
  scene: { BindSites: ['electron'], nearby: 45 },
  _ready(self){ },                                             // molecule_name = 'iron_sulfur_cluster_inside_photosystem_I'; super._ready()
