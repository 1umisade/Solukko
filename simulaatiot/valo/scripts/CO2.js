/* CO2 - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/CO2.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['CO2'] = {
  scene: { radius: 2 },
  _ready(self){ },                                             // molecule_name = 'CO2'; super._ready()
