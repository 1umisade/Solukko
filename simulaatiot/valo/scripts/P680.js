/* P680 - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/P680.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['P680'] = {
  scene: { BindSites: ['electron'], place: 4, excitable: true, nearby: 45 },
