/* pheophytin - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/pheophytin.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['pheophytin'] = {
  scene: { BindSites: ['electron'], place: 5, nearby: 45 },
  _ready(self){ },                                             // molecule_name = 'pheophytin'; super._ready()
