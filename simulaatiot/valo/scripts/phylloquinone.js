/* phylloquinone - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/phylloquinone.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['phylloquinone'] = {
  scene: { BindSites: ['electron'], place: 16, nearby: 45 },
  _ready(self){ },                                             // molecule_name = 'phylloquinone'; super._ready()
