/* plastoquinone_A - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/plastoquinone_A.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['plastoquinone_A'] = {
  scene: { BindSites: ['electron'], place: 6, nearby: 45 },
  _ready(self){ },                                             // molecule_name = 'plastoquinone_A'; super._ready()
