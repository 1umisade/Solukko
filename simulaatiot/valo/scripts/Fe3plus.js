/* Fe3+ - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/Fe_3+.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['Fe3+'] = {
  scene: { BindSites: ['electron'], place: 7, nearby: 45 },
  _ready(self){ },                                             // molecule_name = 'Fe3+'; super._ready()
