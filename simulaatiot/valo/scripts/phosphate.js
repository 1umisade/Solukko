/* phosphate - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/phosphate.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['phosphate'] = {
  scene: { radius: 2 },
  _ready(self){ },                                             // molecule_name = 'phosphate'; super._ready()
