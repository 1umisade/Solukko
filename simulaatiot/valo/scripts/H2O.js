/* H2O - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/H2O.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['H2O'] = {
  scene: { radius: 1.6 },
  _ready(self){ },                                             // molecule_name = 'H2O'; super._ready()
