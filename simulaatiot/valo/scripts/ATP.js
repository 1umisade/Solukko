/* ATP - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/ATP.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['ATP'] = {
  scene: { radius: 4 },
  _ready(self){ },                                             // molecule_name = 'ATP'; super._ready()
