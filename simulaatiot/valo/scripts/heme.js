/* heme - transcribed from ProjectMPB/Project/Scenes/Level_7_scenes_and_scripts/heme.gd (Godot). See valo/MoleculeBody3D.js. */
(function(){ const V = window.VALO; const white = V.white, dark = V.dark, slot = V.slot;
V.SCRIPTS['heme'] = {
  scene: { BindSites: ['electron'], nearby: 60 },
  _ready(self){ },                                             // molecule_name = 'heme'; super._ready()
