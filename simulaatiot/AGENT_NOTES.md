...
- Kalvostoon-lento (12.9.2026): maali on omistajan dev-lukeman tarkka nakyma (sij. 33, 224, -904 · α -448.7° β 68.5° kierto 1.3° · et. 386). POSE rakentaa siita position, targetin JA upVectorin: ArcRotate laskee offsetin (cos α sin β, cos β, sin α sin β) upVectorin Y-kehyksessa (yToUp), β on upVectorin ja offsetin kulma, kierto on ruutu-ylan (upVector miinus katseakselin komponentti) kulma vaakatasosta (maailman Z) - U = -cos β·fw + sin β·screenUp on kiintopiste, joka iteroidaan. Lento liu'uttaa myos upVectorin (copyFrom + setMatUp). Lukema α tulee -88.7° = -448.7° + 360°.
