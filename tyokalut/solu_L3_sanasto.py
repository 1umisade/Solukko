...
K("Mikä on kromosomi?",
  "Yksi pitkä DNA-molekyyli proteiineineen. Mitoosissa se pakkautuu näkyväksi sauvaksi.",
  "Kromosomi on yksi jatkuva DNA-molekyyli, joka on kiertynyt histonien ympärille kromatiiniksi. Jakautumattomassa solussa kromosomit ovat löyhiä ja näkymättömiä, mutta mitoosissa ne tiivistyvät sauvoiksi, joissa on kaksi identtistä kromatidia. Kromosomien määrä on lajityypillinen: ihmisellä 46 eli 23 paria, simpanssilla 48. Bakteerin kromosomi on tavallisesti yksi rengas. Kromosomiin sisältyvät geenit ja niiden säätelyalueet.",
  3, L('kromosomi')),
K("Mikä on sukusolu?",
